...
//  InitLEDs();
  ...
  CONSOLE("\n priority INT_EMAC0 %08x", IntPriorityGet(INT_EMAC0));
  CONSOLE("\n priority FAULT_SYSTICK %08x", IntPriorityGet(FAULT_SYSTICK));
  CONSOLE("\n priority UART0 %08x", IntPriorityGet(INT_UART0));
  CONSOLE("\n priority UART1 %08x", IntPriorityGet(INT_UART1));
  CONSOLE("\n priority UART2 %08x", IntPriorityGet(INT_UART2));
  CONSOLE("\n priority UART3 %08x", IntPriorityGet(INT_UART3));
  CONSOLE("\n priority UART4 %08x", IntPriorityGet(INT_UART4));
  CONSOLE("\n priority INT_TIMER1A %08x", IntPriorityGet(INT_TIMER1A));
