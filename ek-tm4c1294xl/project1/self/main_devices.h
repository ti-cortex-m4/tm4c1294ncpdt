...
typedef enum
{
  ...
  DEV_HEADER_B2x12      =  0x218,
  DEV_POSTHEADER_B2x12  =  0x219,
...
//  DEV_POSTCONFIG_V3     =  0x1B22,
  ...
  DEV_START_40C         =  0x2400,
  DEV_DISC_O_40C        =  0x2401,
  DEV_DISC_I_40C        =  0x2402,
  DEV_SNRM_O_40C        =  0x2403,
  DEV_SNRM_I_40C        =  0x2404,
  DEV_AARQ_O_40C        =  0x2405,
  DEV_AARQ_I_40C        =  0x2406,
  DEV_RR_AARQ_O_40C     =  0x2407,
  DEV_RR_AARQ_I_40C     =  0x2408,
  DEV_VALUE_O_40C       =  0x2409,
  DEV_VALUE_I_40C       =  0x2410,
  DEV_RR_VALUE_O_40C    =  0x2411,
  DEV_RR_VALUE_I_40C    =  0x2412,
  DEV_SCALER_O_40C      =  0x2413,
  DEV_SCALER_I_40C      =  0x2414,
  DEV_RR_SCALER_O_40C   =  0x2415,
  DEV_RR_SCALER_I_40C   =  0x2416,

  DEV_START_40P         =  0x2420,
  DEV_DISC_O_40P        =  0x2421,
  DEV_DISC_I_40P        =  0x2422,
  DEV_SNRM_O_40P        =  0x2423,
  DEV_SNRM_I_40P        =  0x2424,
  DEV_AARQ_O_40P        =  0x2425,
  DEV_AARQ_I_40P        =  0x2426,
  DEV_RR_AARQ_O_40P     =  0x2427,
  DEV_RR_AARQ_I_40P     =  0x2428,

  DEV_TIME1_O_40P       =  0x2429,
  DEV_TIME1_I_40P       =  0x242A,
  DEV_RR_TIME1_O_40P    =  0x242B,
  DEV_RR_TIME1_I_40P    =  0x242C,

  DEV_CORRECT_40P       =  0x242D,
  DEV_CORRECT_O_40P     =  0x242E,
  DEV_CORRECT_I_40P     =  0x242F,
  DEV_RR_CORRECT_O_40P  =  0x2430,
  DEV_RR_CORRECT_I_40P  =  0x2431,
  
  DEV_TIME2_O_40P       =  0x2432,
  DEV_TIME2_I_40P       =  0x2433,
  DEV_RR_TIME2_O_40P    =  0x2434,
  DEV_RR_TIME2_I_40P    =  0x2435,

  DEV_SCALER_O_40P      =  0x2436,
  DEV_SCALER_I_40P      =  0x2437,
  DEV_RR_SCALER_O_40P   =  0x2438,
  DEV_RR_SCALER_I_40P   =  0x2439,

  DEV_INIT_40P          =  0x2440,
  DEV_QUERY_40P         =  0x2441,
  DEV_14_40P            =  0x2442,
  DEV_15_40P            =  0x2443,
  DEV_1_RR_O_40P        =  0x2444,
  DEV_1_RR_I_40P        =  0x2445,
  DEV_2_RR_O_40P        =  0x2446,
  DEV_2_RR_I_40P        =  0x2447,
  DEV_READ_3_40P        =  0x2448,
  DEV_READ_4_40P        =  0x2449,
  DEV_20_40P            =  0x2450,
  DEV_3_RR_O_40P        =  0x2451,
  DEV_3_RR_I_40P        =  0x2452,
  DEV_4_RR_O_40P        =  0x2453,
  DEV_4_RR_I_40P        =  0x2454,
  DEV_FINISH_40P        =  0x2455,
  ...
  DEV_TIME1_41P         =  0x2512,
  DEV_POSTTIME1_41P     =  0x2513,

  DEV_PREVAUTHKEY1_41P  =  0x2514,
  DEV_AUTHKEY1_41P      =  0x2515,
  DEV_POSTAUTHKEY1_41P  =  0x2516,
  DEV_AUTHREQ1_41P      =  0x2517,
  DEV_PREVCORRECT_41P   =  0x2518,
  DEV_CORRECT_41P       =  0x2519,

  DEV_PREVAUTHKEY2_41P  =  0x2520,
  DEV_AUTHKEY2_41P      =  0x2521,
  DEV_POSTAUTHKEY2_41P  =  0x2522,
  DEV_AUTHREQ2_41P      =  0x2523,
  DEV_PREVMANAGE_41P    =  0x2524,
  DEV_MANAGE_41P        =  0x2525,

  DEV_PREVTIME2_41P     =  0x2526,
  DEV_TIME2_41P         =  0x2527,

  DEV_INITHEADER_41P    =  0x2528,
  DEV_PAUSE_41P         =  0x2529,
  DEV_HEADER_41P        =  0x252A,
