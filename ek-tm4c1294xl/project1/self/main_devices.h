...
//  DEV_POSTCONFIG_V3     =  0x1B22,
  ...
  DEV_START_W2          =  0x1C00,
  DEV_PREVCORRECT_W2    =  0x1C01,
  DEV_CORRECT_W2        =  0x1C02,
  DEV_OPEN_W2           =  0x1C03,
  ...
  DEV_PREVTIME_W2       =  0x1C15,
  DEV_TIME_W2           =  0x1C0A,
  DEV_POSTTIME_W2       =  0x1C0B,
  DEV_DATE_W2           =  0x1C0C,
  DEV_POSTDATE_W2       =  0x1C0D,
  DEV_CONTROL_W2        =  0x1C0E,
  DEV_POSTCONTROL_W2    =  0x1C0F,
  DEV_POSTCORRECT_W2    =  0x1C10,
  DEV_HEADER_W2         =  0x1C11,
  DEV_POSTHEADER_W2     =  0x1C12,
  DEV_DATA_W2           =  0x1C13,
  DEV_PREVHEADER_W2     =  0x1C14,
