...
//  DEV_POSTCONFIG_V3     =  0x1B22,
  ...
  DEV_PREVAUTH1KEY_34P  =  0x2006,
  DEV_AUTH1KEY_34P      =  0x2007,
  DEV_POSTAUTH1KEY_34P  =  0x2008,
  DEV_AUTH1REQ_34P      =  0x2009,

  DEV_PREVCORRECT_34P   =  0x200A,
  DEV_CORRECT_34P       =  0x200B,

  DEV_PREVAUTH2KEY_34P  =  0x200C,
  DEV_AUTH2KEY_34P      =  0x200D,
  DEV_POSTAUTH2KEY_34P  =  0x200E,
  DEV_AUTH2REQ_34P      =  0x200F,
