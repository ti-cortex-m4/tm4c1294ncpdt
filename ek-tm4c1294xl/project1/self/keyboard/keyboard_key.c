...
#include "digitals/review/key_review_repeat_regular.h"
...
void    Keyboard_Key(void)
{
  if (enGlobal == GLB_PROGRAM)
  {
    switch (wProgram)
    {
      ...
      case wSET_REVIEW_REPEAT_REGULAR: key_SetReviewRepeatRegular(); break;
      case wSET_REVIEW_REPEAT_WARNING: key_SetReviewRepeatWarning(); break;
      case wSET_REVIEW_REPEAT_TOTAL: key_SetReviewRepeatTotal(); break;
