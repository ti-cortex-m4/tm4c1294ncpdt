...
#include "../sensors/sensor39/correct39.h"
...
// чтение времени для чтения профилей
    ...
    case DEV_DISC_I_39C:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        ...
        CURRENT39_REPEAT_OR_ERROR(190+0, DISC_Current39(), DEV_DISC_I_39C)
      }
      break;
    ...
    case DEV_SNRM_I_39C:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        ...
        CURRENT39_REPEAT_OR_ERROR(190+1, SNRM_Current39(), DEV_SNRM_I_39C)
      }
      break;
    ...
    case DEV_AARQ_I_39C:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Current39()) {
          CURRENT39_REPEAT_OR_ERROR(190+2, AARQ_Current39(), DEV_AARQ_I_39C)
        } else {
          if (AARE_CheckPass()) {
        ...
        CURRENT39_REPEAT_OR_ERROR(190+4, AARQ_Current39(), DEV_AARQ_I_39C)
      }
      break;
    ...
    case DEV_RR_AARQ_I_39C:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Current39()) {
          CURRENT39_REPEAT_OR_ERROR(190+5, RR_Current39(), DEV_RR_AARQ_I_39C)
        } else {
          ClearLine39();
          MakePause(DEV_VALUE_O_39C);
        }
      } else {
        CURRENT39_REPEAT_OR_ERROR(190+6, RR_Current39(), DEV_RR_AARQ_I_39C)
      }
      break;
    ...
    case DEV_VALUE_I_39C:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Current39()) {
          CURRENT39_REPEAT_OR_ERROR(190+7, QueryValue_Current39(), DEV_VALUE_I_39C)
        } else {
        ...
        CURRENT39_REPEAT_OR_ERROR(190+9, QueryValue_Current39(), DEV_VALUE_I_39C)
      }
      break;
    ...
    case DEV_RR_VALUE_I_39C:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Current39()) {
          CURRENT39_REPEAT_OR_ERROR(190+10, RR_Current39(), DEV_RR_VALUE_I_39C)
        } else {
          if (IncLine39() < 4)
            MakePause(DEV_VALUE_O_39C);
          else
        ...
        CURRENT39_REPEAT_OR_ERROR(190+11, RR_Current39(), DEV_RR_VALUE_I_39C)
      }
      break;
    ...
    case DEV_SCALER_I_39C:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        ...
        CURRENT39_REPEAT_OR_ERROR(190+14, QueryScaler_Current39(), DEV_SCALER_I_39C)
      }
      break;
    ...
    case DEV_RR_SCALER_I_39C:
      if (mpSerial[ibPort] == SER_GOODCHECK)  {
        if (!ValidateFrame_Current39()) {
          CURRENT39_REPEAT_OR_ERROR(190+15, RR_Current39(), DEV_RR_SCALER_I_39C)
        } else {
          ReadCurrent39();
        }
      } else {
        CURRENT39_REPEAT_OR_ERROR(190+16, RR_Current39(), DEV_RR_SCALER_I_39C)
      }
      break;
    ...
    case DEV_DISC_I_40P:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        ...
        PROFILE39_REPEAT_OR_ERROR(210+0, DISC_Profile39(), DEV_DISC_I_40P)
      }
      break;
    ...
    case DEV_SNRM_I_40P:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        ...
        PROFILE39_REPEAT_OR_ERROR(210+1, SNRM_Profile39(), DEV_SNRM_I_40P)
      }
      break;
    ...
    case DEV_AARQ_I_40P:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Profile39()) {
          PROFILE39_REPEAT_OR_ERROR(210+2, AARQ_Profile39(), DEV_AARQ_I_40P)
        } else {
          if (AARE_CheckPass()) {
        ...
        PROFILE39_REPEAT_OR_ERROR(210+4, AARQ_Profile39(), DEV_AARQ_I_40P)
      }
      break;
    ...
    case DEV_RR_AARQ_I_40P:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Profile39()) {
          PROFILE39_REPEAT_OR_ERROR(210+5, RR_Profile39(), DEV_RR_AARQ_I_40P)
        } else {
          Init_Correct39();
        ...
        PROFILE39_REPEAT_OR_ERROR(210+6, RR_Profile39(), DEV_RR_AARQ_I_40P)
      }
      break;
    ...
    case DEV_TIME1_I_40P:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Profile39()) {
          PROFILE39_REPEAT_OR_ERROR(210+7, QueryTime_Profile39(), DEV_TIME1_I_40P)
        } else {
          ReadTime_Profile39();
          MakePause(DEV_RR_TIME1_O_40P);
        }
      } else {
        PROFILE39_REPEAT_OR_ERROR(210+8, QueryTime_Profile39(), DEV_TIME1_I_40P)
      }
      break;
    ...
    case DEV_RR_TIME1_I_40P:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Profile39()) {
          PROFILE39_REPEAT_OR_ERROR(210+9, RR_Profile39(), DEV_RR_TIME1_I_40P)
        } else {
          MakePause(DEV_CORRECT_40P);
        }  
      } else {
        PROFILE39_REPEAT_OR_ERROR(210+10, RR_Profile39(), DEV_RR_TIME1_I_40P)
      }
      break;
    ...
    case DEV_CORRECT_I_40P:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Profile39()) {
          PROFILE39_REPEAT_OR_ERROR(210+11, QueryCorrect_Profile39(), DEV_CORRECT_I_40P)
        } else {
          MakePause(DEV_RR_CORRECT_O_40P);
        }
      } else {
        PROFILE39_REPEAT_OR_ERROR(210+12, QueryCorrect_Profile39(), DEV_CORRECT_I_40P)
      }
      break;
    ...
    case DEV_RR_CORRECT_I_40P:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Profile39()) {
          PROFILE39_REPEAT_OR_ERROR(210+13, RR_Profile39(), DEV_RR_CORRECT_I_40P)
        } else {
          MakeLongPause(DEV_TIME1_O_40P, 1); // снова проверяем время
        }  
      } else {
        PROFILE39_REPEAT_OR_ERROR(210+14, RR_Profile39(), DEV_RR_CORRECT_I_40P)
      }
      break;
    ...
    case DEV_TIME2_I_40P:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Profile39()) {
          PROFILE39_REPEAT_OR_ERROR(210+15, QueryTime_Profile39(), DEV_TIME2_I_40P)
        } else {
          ReadTime_Profile39();
          MakePause(DEV_RR_TIME2_O_40P);
        }
      } else {
        PROFILE39_REPEAT_OR_ERROR(210+16, QueryTime_Profile39(), DEV_TIME2_I_40P)
      }
      break;
    ...
    case DEV_RR_TIME2_I_40P:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Profile39()) {
          PROFILE39_REPEAT_OR_ERROR(210+17, RR_Profile39(), DEV_RR_TIME2_I_40P)
        } else {
          MakePause(DEV_SCALER_O_40P);
        }  
      } else {
        PROFILE39_REPEAT_OR_ERROR(210+18, RR_Profile39(), DEV_RR_TIME2_I_40P)
      }
      break;
    ...
    case DEV_QUERY_40P: // repeat: step 39.27
      cbRepeat = MaxRepeats();
    ...
    case DEV_15_40P:
      if (!LastSegmentDMLS()) { // true: step 39.7
        MakePause(DEV_1_RR_O_40P); // -> step 39.8
      } else {
        MakePause(DEV_2_RR_O_40P); // -> step 39.11
      }
      break;
    ...
    case DEV_1_RR_I_40P:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Profile39()) {
          ...
          MakePause(DEV_15_40P); // repeat: step 39.10 -> step 39.7
        }
      } else {
    ...
    case DEV_READ_3_40P:
      if (UseBlocks_Profile39()) { // step 39.13
        ...
        MakePause(DEV_FINISH_40P); // step 39.16 -> step 39.24
      }
      break;
    ...
    case DEV_20_40P:
      if (!LastSegmentDMLS()) { // true: step 38.18
        MakePause(DEV_3_RR_O_40P); // -> step 39.19
      } else {
        MakePause(DEV_4_RR_O_40P); // -> step 39.22
      }
      break;
    ...
    case DEV_3_RR_I_40P:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Profile39()) {
          ...
          MakePause(DEV_20_40P); // repeat: step 39.21 -> 39.18
        }
      } else {
    ...
    case DEV_4_RR_I_40P:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Profile39()) {
          ...
          MakePause(DEV_READ_3_40P); // repeat: step 39.23 -> step 39.13
        }
      } else {
    ...
    case DEV_FINISH_40P: // step 39.24
      {
        bool2 b2 = FinishProfile_Profile39(); // steps 39.25, 39.26
        if (!b2.fValid)
          ErrorProfile();
        else if (b2.fValue)
          MakePause(DEV_QUERY_40P); // repeat: step 39.27
        else
