...
// чтение времени для чтения профилей
    ...
    case DEV_SCALER_I_39P:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Profile39()) {
          PROFILE39_REPEAT_OR_ERROR(210+19, QueryScaler_Profile39(), DEV_SCALER_I_39P)
        } else {
        ...
        PROFILE39_REPEAT_OR_ERROR(210+21, QueryScaler_Profile39(), DEV_SCALER_I_39P)
      }
      break;
    ...
    case DEV_RR_SCALER_I_39P:
      if (mpSerial[ibPort] == SER_GOODCHECK) {
        if (!ValidateFrame_Profile39()) {
          PROFILE39_REPEAT_OR_ERROR(210+22, RR_Profile39(), DEV_RR_SCALER_I_39P)
        } else {
          MakePause(DEV_INIT_39P);
        }  
      } else {
        PROFILE39_REPEAT_OR_ERROR(210+23, RR_Profile39(), DEV_RR_SCALER_I_39P)
      }
      break;
