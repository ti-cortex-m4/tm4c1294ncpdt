...
typedef enum
{
  ...
  DF_IMPDAYCAN_IMG      = DF_CNTMONCAN + bREAL_CAN*bMONTHS,
  DF_IMPMONCAN_IMG      = DF_IMPDAYCAN_IMG + bIMPULSE_CAN,
  DF_POWDAYGRP_IMG      = DF_IMPMONCAN_IMG + bIMPULSE_CAN,
  DF_POWMONGRP_IMG      = DF_POWDAYGRP_IMG + bPOWER_GRP,

  DF_END                = DF_POWMONGRP_IMG + bPOWER_GRP
} flash;
